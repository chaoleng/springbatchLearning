...
//	
//	@Bean
//	public Flow splitDemoFolw1() {
//		return new FlowBuilder<Flow>("splitDemoFolw1")
...
//	
//	@Bean
//	public Flow splitDemoFolw2() {
//		return new FlowBuilder<Flow>("splitDemoFolw2")
...
//				.start(splitDemoFolw1())
//				.split(new SimpleAsyncTaskExecutor()).add(splitDemoFolw2())
//				.end()
//				.build();
//	}
//}
